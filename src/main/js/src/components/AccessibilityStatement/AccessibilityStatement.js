...
const AccessibilityStatement = () => (
	<html lang="fi">
		...
		<body>
			<article>
				<header>
					<h1>Tervetuloa, tämä on organisaation Opetushallitus Saavutettavuusseloste</h1>
				</header>

				<section class="statement__section">
					<p>Tämä saavutettavuusseloste koskee palvelua https://yki.opintopolku.fi ja on laadittu / päivitetty 26.10.2021. Palvelua koskee laki digitaalisten palvelujen tarjoamisesta, jossa edellytetään, että julkisten verkkopalvelujen on oltava saavutettavia.</p>
          <p>Palvelun saavutettavuuden on arvioinut ulkopuolinen asiantuntijaorganisaatio.</p>
				</section>
				...
				<section class="statement__section">
					<section class="statement__inaccessible">
						...
						<ul class="flaws">
							<li class="flaw">
								<h4 class="flaw__title">Havaittava: Videosta puuttuu tekstitys</h4>
								<h5 class="flaw__subtitle">Saavuttamaton sisältö ja sen puutteet</h5>
							...
							<li class="flaw">
								<h4 class="flaw__title">Havaittava: Ruudunlukijan käytössä puutteita</h4>
                <h5 class="flaw__subtitle">Saavuttamaton sisältö ja sen puutteet</h5>
                <p>Ruudunlukija lukee nappien taakse piilotettua sisältöä vaikkei sisältöä olisi avattu</p>
                <h5>Saavutettavuusvaatimukset jotka eivät täyty</h5>
                <ul class="flaw__wcag">
							...
							<li class="flaw">
								<h4 class="flaw__title">Havaittava: Sovelluksesta puuttuu nimilappuja</h4>
								<h5 class="flaw__subtitle">Saavuttamaton sisältö ja sen puutteet</h5>
                ...
                <ul class="flaw__wcag">
							...
							<li class="flaw">
								<h4 class="flaw__title">Havaittava: Burger menun sisältö ei näy kokonaan</h4>
								<h5 class="flaw__subtitle">Saavuttamaton sisältö ja sen puutteet</h5>
								<p>Burger menun sisältö ei näy kokonaan kaikilla mobiililaitteilla</p>
								<h5>Saavutettavuusvaatimukset jotka eivät täyty</h5>
                <ul class="flaw__wcag">
							...
							<li class="flaw">
								<h4 class="flaw__title">Hallittava: Näppäimistöansa</h4>
								<h5 class="flaw__subtitle">Saavuttamaton sisältö ja sen puutteet</h5>
								<p>Näppäimistöansa mobiilimenun kielivalinnassa liikkuessa tab-näppäimellä</p>
								<h5>Saavutettavuusvaatimukset jotka eivät täyty</h5>
                <ul class="flaw__wcag">
							...
							<li class="flaw">
								<h4 class="flaw__title">Ymmärrettävä: Merkinnät eivät kaikilta osin johdonmukaisia</h4>
								<h5 class="flaw__subtitle">Saavuttamaton sisältö ja sen puutteet</h5>
								<p>Linkit ja painikkeet eivät aina ole johdonmukaisesti merkittyjä</p>
								<h5>Saavutettavuusvaatimukset jotka eivät täyty</h5>
                <ul class="flaw__wcag">
							...
							<li class="flaw">
								<h4 class="flaw__title">Ymmärrettävä: Virheellisesti syötettyyn tai puuttuvaan tietoon ohjaaminen</h4>
								<h5 class="flaw__subtitle">Saavuttamaton sisältö ja sen puutteet</h5>
                ...
                <ul class="flaw__wcag">
							...
							<li class="flaw">
								<h4 class="flaw__title">Toimintavarma: Kaikki pääsisältö ei ole kääritty main elementin sisään</h4>
								<h5 class="flaw__subtitle">Saavuttamaton sisältö ja sen puutteet</h5>
