...
const AddExamDate = props => {
  ...
  const initializeLanguageArray = () => {
    ...
    if (
      examDates.length > 0 &&
      examDates[0].languages &&
      examDates[0].languages.length > 0
    ) {
        ...
        <Form className={classes.Form}>
              ...
              return (
                <span key={i}>
                  ...
                  <p style={{ marginLeft: '10px' }}>
                    {languageToString(item.language_code)},{' '}
                    {levelDescription(item.level_code)}
                  </p>
                </span>
              );
            })}
          ...
          <div className={classes.ActionButtons}>
            <button
              ...
              type="submit"
              className={
                isValid ? classes.ConfirmButton : classes.DisabledButton
              }
              disabled={!isValid}
            >
...
AddExamDate.propTypes = {
  examDates: PropTypes.oneOfType([PropTypes.object, PropTypes.array])
    .isRequired,
